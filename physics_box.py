from vpython import *
class PhysicsBox:
    def __init__(self, type='box', mass=1, pos=vec(0, 0, 0), axis=vec(1, 0, 0), size=vec(1, 1, 1), color=color.black, radius=1, make_trail=False, trail_type="points", interval=10, velocity=vec(0, 0, 0), texture=textures.metal):
        self.type = type
        if type == 'box':
